...
public class GarbageCreator {
    // Read a file (or generate data if no file) and concatenate bytes into a String using + (inefficient)
    public static void main(String[] args) {
        ...
        System.out.println("GarbageCreator: concatenating using + operator (this will create lots of temporary strings)...");
